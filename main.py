...
async def command_start(message: Message, state: FSMContext) -> None:
    ...
    if userData:
        ...
        await message.answer("Hi there! Welcome to TechNest's Solana Trading Bot!", reply_markup=main_menu_keyboard)
...
async def main_menu(message: Message, state: FSMContext) -> None:
    await state.set_state(Form.start_menu)
    await message.edit_text("Hi there! Welcome to TechNest's Solana Trading Bot!", reply_markup=main_menu_keyboard)
